...
def listTujuan():
    try:
        data= open('Tugas Final/receiver_list.txt','r')
...
def tambahTujuan():
    try:
        ...
        if data.read()=='':
            data = open('Tugas Final/receiver_list.txt','a')
...
def owTujuan():
    nama = input(f"Masukkan Nama Tujuan: ")
    tujuan= input(f"Masukkan Email Tujuan: ")
    data = open('Tugas Final/receiver_list.txt','w')
    data.write(nama+','+tujuan)
    data.close()
    print('\nData Tujuan Berhasil Ditambah!\n')
    mainMenu()
...
def kirimEmail():
    ...
    try:
        ...
        for cetak in read_file:
            ...
            #template
            html = open("Tugas Final/template.html")
